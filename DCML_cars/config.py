...
def get_config():
    ...
    parser.add_argument('--use_dataset', type=str, default='Cars', choices=['Cars'])
    ...
    # optimization
    parser.add_argument('--lr', type=float, default=7.41e-3)
    parser.add_argument('--lr_at', type=float, default=2e-6)
    ...
    parser.add_argument('--margin', type=float, default=0.4324) # 
    parser.add_argument('--scale', type=float, default=161.5) #
    parser.add_argument('--train_class', type=int, default=74)
    ...
    parser.add_argument('--datapth', type=str, default='/home/xiang/data/cars_metric/CARS196/')
