...
def test_dim128(model, at, head, conf):
    ...
    if conf.use_dataset == 'Cars':
        dataset = MSBaseDataSet(conf, '/home/xiang/data/cars_metric/CARS196/cars_test.txt', 
...
if __name__ == '__main__':
    ...
    if conf.test_pretrained_model!=1:
        ...
        model_path = os.path.join(conf.save_folder, 'valid_ckpt_crossid{cross_id}_seed{seed}_regcof{regcof}_atcof{atcof}_wcof{w_cof}.pth'.format(cross_id=1, seed=conf.seed, regcof=conf.reg_cof, atcof=conf.at_cof, w_cof=conf.w_cof))     
        ...
        model_path = os.path.join(conf.save_folder, 'valid_ckpt_crossid{cross_id}_seed{seed}_regcof{regcof}_atcof{atcof}_wcof{w_cof}.pth'.format(cross_id=2, seed=conf.seed+2, regcof=conf.reg_cof, atcof=conf.at_cof, w_cof=conf.w_cof))
        ...
        model_path = os.path.join(conf.save_folder, 'valid_ckpt_crossid{cross_id}_seed{seed}_regcof{regcof}_atcof{atcof}_wcof{w_cof}.pth'.format(cross_id=3, seed=conf.seed+4, regcof=conf.reg_cof, atcof=conf.at_cof, w_cof=conf.w_cof))
        ...
        model_path = os.path.join(conf.save_folder, 'valid_ckpt_crossid{cross_id}_seed{seed}_regcof{regcof}_atcof{atcof}_wcof{w_cof}.pth'.format(cross_id=4, seed=conf.seed+6, regcof=conf.reg_cof, atcof=conf.at_cof, w_cof=conf.w_cof))
