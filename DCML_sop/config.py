...
def get_config():
    ...
    parser.add_argument('--use_dataset', type=str, default='SOP', choices=['SOP'])
    ...
    # optimization
    parser.add_argument('--lr', type=float, default=2.16e-3)
    ...
    parser.add_argument('--updata_env', type=int, default=10)
    ...
    parser.add_argument('--margin', type=float, default=0.3364) # 
    parser.add_argument('--scale', type=float, default=100.0) #
    parser.add_argument('--train_class', type=int, default=8489)
    ...
    parser.add_argument('--datapth', type=str, default='/home/xiang/data/sop_metric/SOP/')
